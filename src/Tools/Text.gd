...
var text_edit_tscn := preload("res://src/UI/Nodes/TextToolEdit.tscn")
...
func draw_start(position: Vector2) -> void:
	...
	text_edit = text_edit_tscn.instance()
	text_edit.text = ""
	text_edit.font = font
...
func _on_TextSizeSlider_value_changed(value: float) -> void:
	text_size = value
	font.size = text_size
...
func _on_OutlineSlider_value_changed(value: float) -> void:
	outline_size = value
